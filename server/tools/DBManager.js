...
DBManager.prototype.connectDB = function (dbConfig) {
    ...
    try {
        ...
        this.opretation("CREATE TABLE `user` (`user_id` bigint(20) auto_increment NOT NULL PRIMARY KEY,`username` varchar(100) NOT NULL UNIQUE,`password` varchar(50) NOT NULL DEFAULT '000000',`phone` bigint(11) NOT NULL UNIQUE,`uuid` bigint(20),`date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP)");
